...
\begin{fmffile}{FeynmanT10StyleStealthSquark}
\parbox{300mm}{
...
\begin{fmfgraph*}(270,135) % \fmfpen{thick}
  ...
  \fmfforce{0.36w,0.25h}{v6}
  \fmfforce{0.52w,0.25h}{v7}
  \fmfforce{0.68w,0.25h}{v8}
  \fmfforce{0.84w,0.25h}{v9}
         
  %%%%%%%%%%%% Produced SUSY particles
  \fmf{dashes, label=\sQb, label.side=right, label.dist=3.}{v1,v6} % lower antisquark
  \fmf{dashes, label=\sQ, label.side=left, label.dist=3.}{v1,v2} % upper squark
